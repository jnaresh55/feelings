  ...
  <header id="political-header" class="political-header-one bg">
            ...
            <div class="political-navigation"> 
              ...
              <nav id="menu" class="menu navbar navbar-default">
                <ul class="level-1 navbar-nav">
                  ...
                  <li class="active"><a href="projects.php">Projects</a><span class="has-subnav"><i class="fa fa-angle-down"></i></span>
                    <ul class="sub-menu level-2">
            ...
            <div class="row">
                <div class="col-md-12">
            		<div class="political-subheader-wrap">
	            		<h1>Project in Details</h1>
	            		<div class="widget widget_search">
                            <form>
                                <input type="text" placeholder="Search the Project">
	...
	<div class="political-main-content">
		...
		<div class="political-main-section">
			...
			<div class="row">
					<div class="col-md-12">
                        <div class="political-blog political-blog-list political-related-blog">
                        	<ul class="row">
			
			<?php getProjectDetails(); ?>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        ...
        <h5 class="modal-title" id="exampleModalLongTitle">Contact For Buy the Project</h5>
...
if(isset($_POST['submit'])){
    ...
    if(!empty($email) && !empty($name) && !empty($subject) && !empty($phone) && !empty($cname)){
        ...
        if(filter_var($email, FILTER_VALIDATE_EMAIL) === false){
            ...
            $htmlContent = '<h2>Project Request Submitted</h2>
                
				<h4>Name</h4><p>'.$name.'</p>
                <h4>Email</h4><p>'.$email.'</p>
				<h4>Project Name</h4><p>'.$cname.'</p>
