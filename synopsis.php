...
<div class="political-main-wrapper"> 
  ...
  <header id="political-header" class="political-header-one bg">
            ...
            <div class="political-navigation"> 
              ...
              <nav id="menu" class="menu navbar navbar-default">
                <ul class="level-1 navbar-nav">
                  ...
                  <li class="active"><a href="synopsis.php">Synopsis</a></li>
	...
	<div class="political-main-content">
		<div class="container">
        	<h4 class="text-warning">Please Click on name and see the synopsis in details. You can also Download this synopsis in this page</h4><br>
        	<div class="row">
			<div class="col-md-12">
