              ...
              <nav id="menu" class="menu navbar navbar-default">
                <ul class="level-1 navbar-nav">
                  <li><a href="index.php">Home</a></li>
                   ...
                   <li class="active"><a href="shop.php">Shop</a><span class="has-subnav"><i class="fa fa-angle-down"></i></span>
                ...
                <div class="col-md-12">
                	<div class="political-subheader-wrap">
	            		...
	            		<ul class="political-breadcrumb">
				            ...
				            <li class="active">Component Shop</li>
				        </ul>
			        </div>
            	</div>
            </div>
	...
	<div class="political-main-content">
		...
		<div class="political-main-section">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="political-blog political-blog-gridv2">
						<ul class="row">
							<?php getComponent(); ?>
							</ul>
						</div>                                                                   						
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        ...
        <h5 class="modal-title" id="exampleModalLongTitle">Contact For Buy the Component</h5>
...
if(isset($_POST['submit'])){
    ...
    if(!empty($email) && !empty($name) && !empty($subject) && !empty($phone) && !empty($cname)){
        ...
        if(filter_var($email, FILTER_VALIDATE_EMAIL) === false){
            ...
            $htmlContent = '<h2>Component Request Submitted</h2>
                
				<h4>Name</h4><p>'.$name.'</p>
                <h4>Email</h4><p>'.$email.'</p>
				<h4>Component Name</h4><p>'.$cname.'</p>
